...
const CTA = () => {
  ...
  return (
    <div className="rounded-3xl border flex justify-between py-12 px-5 max-w-[800px] mx-auto">
      ...
      <button className={`!${font} border px-8 py-2 rounded-full whitespace-nowrap  bg-black text-white `}><Link href={'/contact'}>{contactButtonTranslation[langauge]} </Link></button>
    </div>
  )
}
